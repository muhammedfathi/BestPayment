...
namespace NaqdiDAL.Migrations
{
    ...
    [Migration("20210411090510_NewTbl-11-04")]
    partial class NewTbl1104
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NaqdiDAL.Models.ChargeSim", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NaqdiDAL.Models.Fields_Mapping", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("Service_ProviderID");

                    b.ToTable("Fields_Mappings");
                });
            ...
            modelBuilder.Entity("NaqdiDAL.Models.Service_Provider", b =>
                {
                    b.Property<int>("Serv_ProvID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("CasesCpsID")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ServiceVerb")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Serv_ProvID");

                    b.HasIndex("CasesCpsID");
            ...
            modelBuilder.Entity("NaqdiDAL.Models.Fields_Mapping", b =>
                {
                    b.HasOne("NaqdiDAL.Models.Service_Provider", "Service_Provider")
                        .WithMany()
                        .HasForeignKey("Service_ProviderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NaqdiDAL.Models.Service_Provider", b =>
                {
                    b.HasOne("NaqdiDAL.Models.CasesCPS", "CasesCPS")
                        .WithMany("Service_Providers")
                        .HasForeignKey("CasesCpsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NaqdiDAL.Models.CasesCPS", b =>
                {
                    ...
                    b.Navigation("Service_Providers");
